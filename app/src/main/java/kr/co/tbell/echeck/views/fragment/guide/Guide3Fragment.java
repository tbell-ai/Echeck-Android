...
public class Guide3Fragment extends Fragment {
    ...
    private static Guide3Fragment instance;

    public static Guide3Fragment newInstance() {
        instance = new Guide3Fragment();
        return instance;
    }

    private Guide3Fragment() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_guide3, container, false);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savingGuideActivity.onInfoPageChange(Guide2Fragment.newInstance(), "prev");
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                savingGuideActivity.onInfoPageChange(Guide4Fragment.newInstance(), "next");
            }
        });
