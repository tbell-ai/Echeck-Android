...
public class HouseDeleteDialog {

    private Context context;
    Button cancel;
    Button okay;
    HouseDeleteDialog.DialogListener dialogListener;

    public HouseDeleteDialog(Context context, HouseDeleteDialog.DialogListener dialogListener) {
    ...
    public void showDialog() {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "가구 정보 삭제를 취소했습니다.", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "해당 가구의 정보를 완전 삭제하겠습니다.", Toast.LENGTH_LONG).show();
